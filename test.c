...
EXP(two_neg   , FIXNUM(-2,0)      , fix_convert_from_double( pow( M_E , fix_convert_to_double(FIXNUM(-2,0)))))     \
                                  /*FIXNUM(0,135335283236612691893999494972484403407631545909575881468158))*/      \
...
EXP(four_neg  , FIXNUM(-4,0)      , fix_convert_from_double( pow( M_E , fix_convert_to_double(FIXNUM(-4,0)))))     \
                                  /*FIXNUM(0,018315638888734180293718021273241242211912067553475594769599))*/      \
...
EXP(e_neg     , fix_neg(FIX_E)    , fix_convert_from_double( pow( M_E , -fix_convert_to_double(FIX_E))))           \
                                  /*FIXNUM(0,065988035845312537076790187596846424938577048252796436402473))*/      \
EXP(ten       , FIXNUM(10,0)      , FIXNUM(22026,46579480671651695790064528424436635351261855678107423542))        \
EXP(ten_neg   , FIXNUM(-10,0)     , fix_convert_from_double( pow( M_E , fix_convert_to_double(FIXNUM(-10,0)))))    \
                                  /*FIXNUM(0,000045399929762484851535591515560550610237918088866564969259))*/      \
...
EXP(regress   , FIXNUM(-1,3862915039), fix_convert_from_double(pow( M_E , fix_convert_to_double(FIXNUM(-1,3862915039)))))
                                  /*FIXNUM(0,25))*/
